...
/**
  ...
  *
  */
void irc_disconnect(struct irc_server *server, char *quit_msg );
...
/**
  ...
  *
  */
int irc_receive(struct irc_server *server, int timeout);
...
/**
  ...
  *
  */
int irc_pong(struct irc_server *server );
...
/**
  ...
  *
  */
int irc_raw_send(const struct irc_server *server, 
                 char *string, ... );
...
/**
  ...
  *
  */
int irc_raw_receive(struct irc_server *server );
...
/**
  ...
  *
  */
int irc_send_cmd(struct irc_server *server,
                 int command, 
                 char  *parameters, ... );
...
/**
  ...
  *
  */
void irc_ini_server(struct irc_server *server);
